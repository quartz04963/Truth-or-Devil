...
public readonly struct TDStage
{
    ...
    static TDStage()
    {
        ...
        stageList[0] = new List<TDData>
        {
            ...
            MyUtils.ConstructTDData(2, 2, "RED"),
            MyUtils.ConstructTDData(3, 2, "1"),
            MyUtils.ConstructTDData(2, 1, WhiteData.Gate, ToD.Devil, 0),
            MyUtils.ConstructTDData(3, 1, WhiteData.Eye, ToD.Devil, 0),
            MyUtils.ConstructTDData(3, 0, WhiteData.Gate, ToD.Truth, 1),
        };
        ...
        stageList[1] = new List<TDData>
        {
            ...
            MyUtils.ConstructTDData(2, 1, "GREEN"),
            MyUtils.ConstructTDData(3, 1, WhiteData.Eye, ToD.Truth, 0),
            MyUtils.ConstructTDData(1, 0, WhiteData.Gate, ToD.Truth, 1),
        ...
        stageList[2] = new List<TDData>
        {
            ...
            MyUtils.ConstructTDData(2, 2, "GATE"),
            MyUtils.ConstructTDData(3, 2, "GREEN"),
            MyUtils.ConstructTDData(0, 1, WhiteData.Blank, ToD.Null, 1),
            MyUtils.ConstructTDData(1, 1, "1"),
            MyUtils.ConstructTDData(2, 1, WhiteData.Eye, ToD.Devil, 0),
            MyUtils.ConstructTDData(3, 1, "8"),
        ...
        stageList[3] = new List<TDData>
        {
            MyUtils.ConstructTDData(2, 3, WhiteData.Gate, ToD.Devil, 0),
            MyUtils.ConstructTDData(1, 2, "GATE"),
            MyUtils.ConstructTDData(2, 2, WhiteData.Eye, ToD.Truth, 0),
            MyUtils.ConstructTDData(3, 2, "GATE"),
            MyUtils.ConstructTDData(0, 1, "1"),
            MyUtils.ConstructTDData(1, 1, "WHITE"),
            MyUtils.ConstructTDData(2, 1, WhiteData.Gate, ToD.Devil, 1),
            MyUtils.ConstructTDData(3, 1, "BLUE"),
            MyUtils.ConstructTDData(4, 1, "0"),
            MyUtils.ConstructTDData(0, 0, WhiteData.Blank, ToD.Null, 1),
            MyUtils.ConstructTDData(1, 0, WhiteData.Blank, ToD.Null, 0),
            MyUtils.ConstructTDData(3, 0, WhiteData.Gate, ToD.Devil, 2),
            MyUtils.ConstructTDData(4, 0, WhiteData.Gate, ToD.Truth, 3),
        };
        ...
        {
            MyUtils.ConstructTDData(1, 3, WhiteData.Blank, ToD.Null, 1),
            MyUtils.ConstructTDData(0, 2, "MAP"),
            MyUtils.ConstructTDData(1, 2, "DEVIL"),
            MyUtils.ConstructTDData(2, 2, "2"),
            MyUtils.ConstructTDData(0, 1, WhiteData.Gate, ToD.Truth, 0),
            MyUtils.ConstructTDData(1, 1, WhiteData.Eye, ToD.Devil, 0),
            MyUtils.ConstructTDData(2, 1, WhiteData.Gate, ToD.Devil, 1),
